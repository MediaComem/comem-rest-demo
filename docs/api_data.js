define({ "api": [
      ...
      "fields": {
        "Response body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "directorId",
            "description": "<p>An Id who is referencing to the person who directed the movie (eg: <code>58b2926f5e1def0123e97bc0</code>)</p>"
          },
          {
            "group": "Response body",
            "type": "String",
        ...
        "URL query parameters": [
          {
            ...
            "optional": true,
            "field": "include",
            "description": "<p>Embed linked resources in the response body:</p> <ul> <li><code>&quot;directorId&quot;</code> for the movie's directorId</li> </ul>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example",
        "content": "GET /api/movies?directorId=58b2926f5e1def0123e97bc0&page=2&pageSize=50 HTTP/1.1",
        "type": "json"
      }
    ],
    "success": {
      ...
      "fields": {
        "Response body": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "directedMovies",
            "description": "<p>The number of movies the person directed</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "group": "Person",
    "version": "1.0.0",
    "description": "<p>Retrieves a paginated list of people sorted by name (in alphabetical order).</p>",
    "parameter": {
      "fields": {
        "URL query parameters": [
          {
    ...
    "examples": [
      {
        "title": "Example",
        "content": "GET /api/people?gender=male&page=2&pageSize=50 HTTP/1.1",
        "type": "json"
      }
    ],
    "success": {
