 ...
 *
 * @apiExample Example
 *     POST /api/movies?include=director HTTP/1.1
  ...
  new Movie(req.body)
    ...
    .then(createdMovie => {
      if (utils.responseShouldInclude(req, 'director')) {
        return createdMovie.populate('directorId');
      }
 ...
 * @apiParam (Request body) {String} directorId An Id who is referencing to the person who directed the movie (e.g.: `58b2926f5e1def0123e97bc0`)
 */
 ...
 * @apiSuccess (Response body) {String} directorId An Id who is referencing to the person who directed the movie (e.g.: `58b2926f5e1def0123e97bc0`)
 * @apiSuccess (Response body) {String} [director] The details of the person who directed the movie (only present if `director` is included with the `include` parameter).
